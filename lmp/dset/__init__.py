...
# Here is content all dataset preprocessing
ALL_DSETS: Final[List[Type[BaseDset]]] = [
    ChPoemDset,
    WikiText2Dset,
]
# Here record the dataset name in their class, every dataset preprocessing need to give this name
# It will look like -> ChPoemDset : 'chinese-poem'
DSET_OPTS: Final[Dict[str, Type[BaseDset]]] = {
    d.dset_name: d
    for d in ALL_DSETS
}
# Here contant the all language, it will be a set, and look like {'zh', 'en'}
